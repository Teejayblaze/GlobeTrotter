$(document).ready(function(){
  ...
  function layout(el, key) {

    // $cond1 = ``; $cond2 = ``; $cond3 = ``;

    // if (el.asset_category == 'digital' || (el.asset_category == 'mobile' && el.advert_type == 'digital')) {
    //   $cond1 = `<div class="column-2">
    //                 <h3><i class="fal fa-hdd"></i> Maximum Slots</h3>
    //                 <p>${el.num_slides}</p>
    //             </div>`;
    // } else {
    //   $cond1 = `<div class="column-2">
    //                 <h3><i class="fal fa-print"></i> Print Dimension</h3>
    //                 <p>${ el.print_dimension ? el.print_dimension : 'N/A' }</p>
    //             </div>`;
    // }

    // if (el.asset_category == 'mobile') {
    //   $cond2 = `<p>${el.advert_type +' '+ el.asset_category}</p>`;
    // } else {
    //   $cond2 = `<p>${el.asset_category[0].toUpperCase() + el.asset_category.substr(1, el.asset_category.length) }</p>`;
    // }

    // if (el.asset_category == 'digital' || (el.asset_category == 'mobile' && el.advert_type == 'digital')){                                            
    //   $cond3 = `<div class="column-2">
    //                 <h3><i class="fal fa-clock"></i> Seconds Per Slot</h3>
    //                 <p>${el.num_slides_per_secs}</p>
    //             </div>`;
    // } else {
    //   $cond3 = `<div class="column-2">
    //                 <h3><i class="fal fa-cubes"></i> Substrate</h3>
    //                 <p>${ el.substrate ? el.substrate : 'N/A' }</p>
    //             </div>`;
    // }

    // return `<div class="advert-board">
    //           <input type="checkbox" name="assets-check" id="check-asset-${key}" style="display:none;" data-name="${el.name}" data-price="${el.max_price}" data-id="${el.id}">
    //           <label for="check-asset-${key}">
    //               <div class="img-holder">
    //                 <div class="faded-img" style="background:url(${el.ajax_images[0]}) no-repeat center center/cover;"></div>
    //                 <p>${el.name}</p>
    //                 <span class="check-correct"></span>
    //               </div>
    //               <div class="content-holder">
    //                   <div class="single-column columns">
    //                       <h3><i class="fal fa-street-view"></i> Location</h3>
    //                       <p>${el.address}</p>
    //                   </div>
    //                   <div class="double-column columns">
    //                       <div class="column-1">
    //                           <h3><i class="fal fa-text-width"></i> Dimension</h3>
    //                           <p>${el.asset_dimension_width}m x ${el.asset_dimension_height}m</p>
    //                       </div>
    //                       ${$cond1}
    //                   </div>
    //                   <div class="double-column columns">
    //                       <div class="column-1">
    //                           <h3><i class="fal fa-coins"></i> Price</h3>
    //                           <p>&#8358;${ setThousandSeparator(el.max_price) }</p>
    //                       </div>
    //                       <div class="column-2">
    //                           <h3><i class="fal fa-donate"></i> Payment Frequency</h3>
    //                           <p>${el.payment_freq}</p>
    //                       </div>
    //                   </div>
    //                   <div class="double-column columns">
    //                       <div class="column-1">
    //                           <h3><i class="fas fa-chalkboard"></i> Board Type</h3>
    //                           ${$cond2}
    //                       </div>
    //                       <div class="column-2">
    //                           <h3><i class="fal fa-cubes"></i> Asset Type</h3>
    //                           <p>${el.asset_type_record.type}</p>
    //                       </div>
    //                   </div>
    //                   <div class="double-column columns">
    //                       <div class="column-1">
    //                           <h3><i class="fal fa-compass"></i> Orientation</h3>
    //                           <p>${el.orientation}</p>
    //                       </div>
    //                       ${$cond3}
    //                   </div>
    //                   <div class="double-column columns">
    //                       <div class="column-1">
    //                           <h3><i class="fal fa-compress"></i> Number of Faces</h3>
    //                           <p>${el.face_count}</p>
    //                       </div>
    //                       <div class="column-2">
    //                           <h3><i class="fal fa-file-pdf"></i> File Format</h3>
    //                           <p>${el.file_format}</p>
    //                       </div>
    //                   </div>
    //               </div>
