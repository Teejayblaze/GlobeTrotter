        ...
        <div class="row">
            <div class="col-md-12">
                <div class="login-header custom-login-header">
                    <p><strong>Your Corporate Information</strong></p>
                    <hr>
                </div>
                    ...
                    <div class="row corporate">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Your Corporate Name <i class="far fa-user"></i> </label>
                                <input type="text" placeholder="Multichoice plc" name="name" id="name" class="required form-control" v-model="corporate.name" data-value="Corporate Name">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Website <i class="far fa-globe"></i></label>
                                <input type="text" placeholder="http://www.multichoice.com" name="website" id="website" class="required form-control" v-model="corporate.website" data-value="Corporate Website">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Email Address <i class="far fa-envelope"></i>  </label>
                                <input type="text" placeholder="j.morre@multichoice.com" name="email" id="email" class="required form-control" v-model="corporate.email" data-value="Corporate Email">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Address <i class="far fa-street-view"></i> </label>
                                <input type="text" placeholder="Your Address" name="address" id="address" class="required form-control" v-model="corporate.address" data-value="Corporate Address">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="87945612233" name="phone" id="phone" class="required form-control" v-model="corporate.phone" data-value="Corporate Phone">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>RC Number <i class="far fa-file-signature"></i>  </label>
                                    <input type="text" placeholder="RC012356" name="rc_number" id="rc_number" class="required form-control" v-model="corporate.rc_number" data-value="Corporate RC Number">
                                </div>
                            </div>
                        </div>
