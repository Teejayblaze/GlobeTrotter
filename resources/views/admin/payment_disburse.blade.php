...
<div class="site-breadcrumb login-breadcrumb dashboard-breadcrumb">
    <div class="container">
        <h2 class="breadcrumb-title dashboard-breadcrumb-menu-left">Pending Disbursed Payment</h2>
        <ul class="breadcrumb-menu dashboard-breadcrumb-menu-left">
            <li><a href="{{ url("/admin/dashboard") }}">Dashboard</a></li>
            <li>Payment Disbursement</li>
            <li class="active-nav-dashboard">Pending Disbursed Payment</li>
        </ul>
    </div>
</div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="user-profile-wrapper wow fadeIn" data-wow-duration="2.5s" data-wow-delay=".25s">
                    ...
                    <h4 class="user-profile-card-title">Pending Disbursed Payment</h4>
                        ...
                        @if (count($transactions))
                            ...
                            <div class="mb-50 pb-40 border-bottom">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="left">Paid?</div><div class="right"><span class="label-warning">{{ @$transaction->paid?'Yes':'No' }}</span></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="left">Asset Owner OAAN ID</div>
                                        <div class="right">{{ @$transaction->asset->owner->oaan_number }}</div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="left">Disbursed?</div><div class="right"><span class="label-warning">{{ $transaction->disbursed?'Yes':'No' }}</span></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">&nbsp;</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="left">&nbsp;</div>
                                        <div class="right">
                                            <form action="{{url('/admin/disbursed/pending')}}" method="post">
                                                @csrf
                                                <div class="form-group">
                                                    <input type="hidden" name="payment_id" value="{{ $transaction->id }}">
                                                    <button type="submit" class="action-button theme-btn theme-btn-custom">Disburse Now <i class="fal fa-cloud"></i></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
